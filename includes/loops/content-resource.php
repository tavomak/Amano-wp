...
<h4>
<em>
<span class="text-muted" class="author"><?php _e('By', 'cam-wp'); echo " "; the_author() ?>,</span>
<time class="text-muted" datetime="<?php the_time('d-m-Y')?>"><?php the_time('jS F Y') ?></time>
</em>
</h4>
<p class="text-muted" style="margin-bottom: 30px;">
<i class="glyphicon glyphicon-folder-open"></i>&nbsp; <?php _e('Filed under', 'cam-wp'); ?>: <?php the_category(', ') ?><br/>
